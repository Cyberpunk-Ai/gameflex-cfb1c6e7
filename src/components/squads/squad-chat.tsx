            ...
            <div key={m.id} className={cn("flex items-end gap-2", mine && "flex-row-reverse")}>
              ...
              <div className={cn("max-w-[76%] group", mine && "text-right")}>
                <div className="flex items-center gap-2 mb-1 text-[11px] text-muted-foreground justify-between">
                  <span className="font-semibold text-foreground/70">{mine ? "You" : m.username}</span>
      ...
      <div className="border-t border-border/40 p-3 space-y-2">
        ...
        >
          <Input
            ...
            maxLength={1000}
          />
          <Button type="submit" size="icon" disabled={!me || !text.trim() || sending} aria-label="Send message">
