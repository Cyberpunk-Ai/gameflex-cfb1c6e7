...
export default function ReferralDashboard() {
  ...
  const baseUrl =
    typeof window !== "undefined" ? window.location.origin : "https://gameflex.app";
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
            <div>
              ...
              <p className="text-muted-foreground mt-1 max-w-xl text-sm sm:text-base">
                Invite gamer friends to GameFlex and grow your squad in the modern gaming
                ecosystem.
              </p>
            </div>
      ...
      <div className="container max-w-5xl mx-auto px-4 sm:px-6 mt-8 space-y-8">
        ...
        <Card className="bg-card border-border/60 shadow-md relative overflow-hidden">
          ...
          <CardHeader className="pb-3">
            ...
            <CardDescription>
              Send your link or code to friends. When they register and play, they're added to
              your referral roster.
            </CardDescription>
          </CardHeader>
